...
import { DOC_CATEGORIES } from '@/data/setup';
import { DOCUMENTS } from '@/data/reports';
import { ROLES } from '@/data/setup';
    ...
    menuColumn((r) => [
      {
        ...
        onSelect: () => {
          downloadCsv(
            [{ key: 'name', header: 'Document' }, { key: 'type', header: 'Type' }, { key: 'merchant', header: 'Merchant' }, { key: 'uploaded', header: 'Uploaded' }],
            [r],
            r.name.replace(/\.[^.]+$/, ''),
          );
