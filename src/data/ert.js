...
export const ERT_NOTIFICATIONS = [
  { id: '1000047', status: 'Closed', created: '2026/08/07', due: '2026/08/11', sender: 'Internal Operations', recipient: 'Citibank', recipientCode: '202678021', priority: 'low', assignee: 'Citi Operations', type: 'Message', description: 'NOTICE: Late Claim Reimbursement Fee applied to the July settlement cycle.', closed: '2026/08/11' },
  ...
  { id: '1000042', status: 'Closed', created: '2026/08/10', due: '2026/08/14', sender: 'Internal Operations', recipient: 'Wells Fargo Bank', recipientCode: '309635021', priority: 'low', assignee: 'Agent T008411', type: 'Message', description: 'Monthly statement delivery confirmed for all merchants in the portfolio.', closed: '2026/08/13' },
  ...
  { id: '1000036', status: 'Closed', created: '2026/08/03', due: '2026/08/06', sender: 'Internal Operations', recipient: 'U.S. Bank', recipientCode: '401276021', priority: 'low', assignee: 'Agent M223511', type: 'Message', description: 'Confirmed receipt of the updated beneficial owner documentation.', closed: '2026/08/05' },
  ...
  { id: '1000029', status: 'Closed', created: '2026/07/01', due: '2026/07/04', sender: 'Internal Operations', recipient: 'Truist Bank', recipientCode: '720000021', priority: 'low', assignee: 'Agent M223511', type: 'Message', description: 'Annual fee schedule review completed and countersigned.', closed: '2026/07/03' },
