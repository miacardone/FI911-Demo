/**
 * ERIC'S NAVIGATION — frozen 2026/08/24.
 *
 * The rail his demo had, with every route moved under /eric so the two
 * consoles cannot collide. Deliberately a separate file from the live
 * navigation: his IA is not a subset of Clive's, and merging them would mean
 * one rail carrying two products' worth of vocabulary.
 */

export const LOGIN_ROUTE = '/login';

export const routes = {
  dashboard: '/eric/dashboard',

  /* Participants */
  invitations: '/eric/participants/invitations',
  invitationDetail: (id = ':id') => `/eric/participants/invitations/${id}`,
  applications: '/eric/participants/applications',
  applicationDetail: (id = ':id') => `/eric/participants/applications/${id}`,
  underwriting: '/eric/participants/underwriting',
  underwritingDetail: (id = ':id') => `/eric/participants/underwriting/${id}`,
  onboarding: '/eric/participants/onboarding',
  onboardingDetail: (id = ':id') => `/eric/participants/onboarding/${id}`,
  liveParticipants: '/eric/participants/live',
  liveParticipantDetail: (id = ':id') => `/eric/participants/live/${id}`,
  participantMerchants: (id = ':id') => `/eric/participants/live/${id}/merchants`,

  /* Customer Services */
  ert: '/eric/customer-services/ert',

  /* Reports */
  merchantGlobal: '/eric/reports/merchant-global',
  productivityReport: '/eric/reports/productivity',

  /* Residuals */
  generalLedger: '/eric/residuals/general-ledger',
  feeAdjustments: '/eric/residuals/fee-adjustments',
  trendingReport: '/eric/residuals/trending-report',
  agentPayoutSummary: '/eric/residuals/agent-payout-summary',
  payoutDetails: '/eric/residuals/payout-details',
  participantStatus: '/eric/residuals/participant-status',
  incomeExpense: '/eric/residuals/income-expense',
  portfolioPayoutDetails: '/eric/residuals/portfolio-payout-details',

  /* Disputes */
  disputes: '/eric/disputes',
  disputeDetail: (id = ':id') => `/eric/disputes/${id}`,
  chargebacksAlerts: '/eric/disputes/alerts',

  /* Risk Management */
  riskDashboard: '/eric/risk-management/dashboard',
  riskMerchants: '/eric/risk-management/merchants',
  alertAction: '/eric/risk-management/alert-action',
  merchantRiskProfile: '/eric/risk-management/merchant-risk-profile',
  heldVolume: '/eric/risk-management/held-volume',
  rules: '/eric/risk-management/rules',
  workQueue: '/eric/risk-management/work-queue',
  workQueueMerchant: (mid = ':mid') => `/eric/risk-management/work-queue/${mid}`,
  actionHistory: '/eric/risk-management/action-history',
  unactionedQueue: '/eric/risk-management/unactioned-queue',

  /* Transactions */
  accountHolder: '/eric/transactions/account-holder',
  gateway: '/eric/transactions/gateway',
  achListings: '/eric/transactions/ach-listings',
  authorizations: '/eric/transactions/authorizations',
  settlements: '/eric/transactions/settlements',
  fundingCategory: '/eric/transactions/funding-category',
  fundingDeposits: '/eric/transactions/funding-deposits',
  qualifications: '/eric/transactions/qualifications',
  merchantReserves: '/eric/transactions/merchant-reserves',

  /* Billing */
  statements: '/eric/billing/statements',

  /* Admin */
  documentCenter: '/eric/document-center',
  setup: '/eric/setup',
};
...
export const setupRoutes = {
  home: '/eric/setup',
  underwriting: '/eric/setup/underwriting',
  pricingSchedules: '/eric/setup/pricing-schedules',
  pricingScheduleDetail: (id = ':id') => `/eric/setup/pricing-schedules/${id}`,
  agentProfiles: '/eric/setup/agent-profiles',
  portfolios: '/eric/setup/portfolios',
  residualApproval: '/eric/setup/residual-approval',
  adjustments: '/eric/setup/adjustments',
  residualCalculation: '/eric/setup/residual-calculation',
  merchantMapping: '/eric/setup/merchant-mapping',
  rulesSetup: '/eric/setup/rules',
  users: '/eric/setup/users',
  banners: '/eric/setup/banners',
  documents: '/eric/setup/documents',
  tenant: '/eric/setup/tenant',
};
