/**
 * FROZEN — Eric's tenant configuration, as it stood on 2026/08/24.
 *
 * The live console moved to a merchant-acquiring model in US dollars. Eric's
 * demo is a UK bank-to-bank participant console, and its data depends on this
 * file's vocabulary: PSP/Bank participant types, FCA consumer dispute
 * categories, GBP, en-GB. Pointing Eric's pages at the live brand config
 * would silently re-label his book with card-scheme reason codes.
 *
 * Nothing outside src/eric imports this. Do not "tidy" it into the live one.
 */
