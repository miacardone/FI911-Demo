/**
 * APM's tenant configuration — separate from the acquiring console's on purpose.
 *
 * Alternative payment methods are bank-to-bank: PSP/Bank participant types,
 * FCA consumer dispute categories, GBP, en-GB. The acquiring console is card
 * schemes in US dollars. Pointing these pages at that brand config would
 * silently relabel this book with card-scheme reason codes it never receives.
 *
 * Nothing outside src/apm imports this. Do not "tidy" it into the other one.
 */
